...
$ecoBonus = ((int) $destination['eco_rating']) * 3;
...
$suggestion = "";
if (($transportMode === 'private_car' || $transportMode === 'airplane') && $distanceKm < 500) {
    $betterOption = ($distanceKm < 15) ? "walking or biking" : "taking a public bus or train";
    $suggestion = "💡 <strong>Eco-Tip:</strong> This destination is only " . number_format($distanceKm, 1) . " km away! Consider $betterOption to boost your sustainability score.";
}
    ...
    <main class="container">
        ...
        <?php if (!empty($notes)): ?>
            <section class="notes-preview">
                <strong style="display: block; margin-bottom: 0.5rem; color: #718096; font-size: 0.8rem; text-transform: uppercase;">Your Itinerary Notes</strong>
                <p style="color: #2d3748; font-style: italic; white-space: pre-wrap;"><?php echo htmlspecialchars($notes); ?></p>
            </section>
        <?php endif; ?>
    </main>
