...
## ✨ Key Features
* **Smart Eco-Scoring:** Real-time calculation of your trip's sustainability score based on transport mode and distance.
* **Dynamic Destination Database:** Browse locations globally with specific "Eco-Notes" for responsible tourism.
